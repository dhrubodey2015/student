...
<head>
    ...
    <link href="{{ asset('newTheme/plugins/custom/fullcalendar/fullcalendar.bundle1894.css?v=7.1.9') }}"
          rel="stylesheet" type="text/css"/>
    <!--end::Page Vendors Styles-->
    <!--begin::Global Theme Styles(used by all pages)-->
    <link href="{{ asset('newTheme/plugins/global/plugins.bundle1894.css?v=7.1.9') }}" rel="stylesheet"
          type="text/css"/>
    <link href="{{ asset('newTheme/plugins/custom/prismjs/prismjs.bundle1894.css?v=7.1.9') }}" rel="stylesheet"
          type="text/css"/>
    <link href="{{ asset('newTheme/css/style.bundle1894.css?v=7.1.9') }}" rel="stylesheet" type="text/css"/>
    <!--end::Global Theme Styles-->
    <!--begin::Layout Themes(used by all pages)-->
    <link href="{{ asset('newTheme/css/themes/layout/header/base/light1894.css?v=7.1.9') }}" rel="stylesheet"
          type="text/css"/>
    <link href="{{ asset('newTheme/css/themes/layout/header/menu/light1894.css?v=7.1.9') }}" rel="stylesheet"
          type="text/css"/>
    ...
    <link href="{{ asset('newTheme/plugins/custom/datatables/datatables.bundle1894.css?v=7.1.9') }}" rel="stylesheet"
          type="text/css"/>
    <!--end::Layout Themes-->
...
<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
    ...
    <!--begin::Logo-->
    <a href="{{url('/')}}">
        <h1><b class="text-white">Student</b><b>Management</b></h1>
    </a>
    <!--end::Logo-->
    <!--begin::Toolbar-->
        ...
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-100 mr-5">
                <!-- <div class="symbol-label"
                     style="background-image:url('{{ asset('newTheme/media/users/300_21.jpg') }}">
                </div>
