						...
						<div class="login-form login-signin">
							...
							<form method="POST" action="{{ route('login') }}">
								...
								<div class="pb-13 pt-lg-0 pt-5">
									<h3 class="font-weight-bolder text-dark font-size-h4">Welcome to Student Management</h3>
								...
								<div class="form-group">
									...
									<input id="email" type="email" class="form-control form-control-solid h-auto py-6 px-6 rounded-lg @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="E-mail ID" autocomplete="off" required autofocus/>
									@error('email')
